...
const SOURCE_HASH = 'sha256:255a8b4762a6844219f465409fc3f36c1672478bd1aeefc4bac8f8d3f46d2b21';
...
(async () => {
  ...
  await page.screenshot({ path: 'qa-artifacts/survey-gen6-admin-public-confirmation-320.png', fullPage: true });
