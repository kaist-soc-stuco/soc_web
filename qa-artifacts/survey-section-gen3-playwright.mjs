...
const sourceHash = 'sha256:666d99afe74537684c9410be32d1c870f8e54d3828b9cf13fa4d94780f1c670b';
...
const transcript = { sourceHash, status: 'passed', commands: [`pnpm --filter @soc/web exec vite --host 127.0.0.1 --port 4199 --strictPort`, `SURVEY_QA_BASE_URL=${baseUrl} node qa-artifacts/survey-section-gen3-playwright.mjs`], assertions: {}, requests: [] };
...
try {
  ...
  await page.screenshot({ path: 'qa-artifacts/survey-section-gen3-screenshot.png', fullPage: true });
  ...
  fs.writeFileSync('qa-artifacts/survey-section-gen3-browser-transcript.json', JSON.stringify(transcript, null, 2) + '\n');
