...
const SOURCE_HASH = 'sha256:da8f3193b40651bb2e5b628fe33452a48315927e31ed58940cb88102cca47451';
...
(async () => {
  ...
  await page.screenshot({ path: 'qa-artifacts/survey-gen4-admin-public-confirmation-320.png', fullPage: true });
