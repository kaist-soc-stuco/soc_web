  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] md:hidden">
      ...
      <section
        ...
        role="dialog"
        className="absolute inset-x-0 bottom-0 max-h-[82dvh] overflow-y-auto rounded-t-[18px] bg-white px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-4 shadow-elevated"
      >
