...
export function AdminPermissionsPage() {
    ...
    if (grants.status === 'idle' || grants.status === 'loading')
        return <section><h1 className="text-[32px] font-extrabold text-kaist-black">{uiText("pages.admin-permissions-page.d8a670873e")}</h1><p className="mt-5 text-sm font-semibold">{uiText("pages.admin-permissions-page.fd041853ed")}</p></section>;
    if (!visible)
        return <section><h1 className="text-[32px] font-extrabold text-kaist-black">{uiText("pages.admin-permissions-page.d8a670873e")}</h1><p role="alert" className="mt-5 text-sm font-semibold text-red-700">{uiText("pages.admin-permissions-page.716f7d1ab9")}</p></section>;
    ...
    return <section>
    <div className="mb-6 border-b border-kaist-grey/25 pb-4"><h1 className="text-[32px] font-extrabold tracking-tight text-kaist-black">{uiText("pages.admin-permissions-page.d8a670873e")}</h1></div>
