...
export function AdminSurveyEditPage() {
  ...
  return <main className="survey-admin-editor mx-auto max-w-5xl"><Link to="/admin/surveys">목록</Link><h1 className="mt-4 text-2xl font-bold">설문 편집</h1>{error && <p role="alert">{error}</p>}
