      ...
      <div className="min-h-[calc(100vh-4.5rem)] bg-[#F7FCFC]">
        <div className="bg-[linear-gradient(90deg,#146D4A_40.8%,#C9ECC2_100%)] py-8">
          <div className={pageContainerClass}>
            <h1 className="mb-2 text-[32px] font-extrabold tracking-tight text-white">{category} 글 작성</h1>
            <p className="text-[20px] font-semibold tracking-tight text-white">{boardInfo[category]?.description ?? ''}</p>
          </div>
        </div>

        <section className={`${pageContainerClass} pb-16 py-2`}>
          <div className="border-b-2 border-kaist-darkgreen-main py-5">
            <h2 className="text-2xl font-extrabold tracking-tight text-kaist-black lg:text-[28px]">
              게시글 작성
            </h2>
            <p className="mt-2 text-sm font-semibold tracking-tight text-kaist-grey">
          ...
          <div className="grid gap-5 py-7 lg:py-8">
            <label className="grid gap-3">
              <span className="text-sm font-extrabold tracking-tight text-kaist-darkgreen lg:text-base">제목</span>
              <input
                type="text"
            ...
            <label className="grid gap-3">
              <span className="text-sm font-extrabold tracking-tight text-kaist-darkgreen lg:text-base">요약</span>
              <input
                type="text"
            ...
            <label className="grid gap-3">
              <span className="text-sm font-extrabold tracking-tight text-kaist-darkgreen lg:text-base">본문</span>
              <textarea
                rows={12}
                placeholder="게시글 내용을 입력하세요"
                className="min-h-[280px] rounded-[5px] border border-kaist-grey/30 bg-white px-4 py-4 text-sm font-medium leading-7 tracking-tight text-kaist-black outline-none transition focus:border-kaist-darkgreen"
              />
            </label>
          </div>
