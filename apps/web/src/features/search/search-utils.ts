...
export const ABOUT_ITEMS: AboutSearchItem[] = [
  {
    ...
    titleKo: "집행위원회 소개",
    titleEn: "About",
    descriptionKo: "전산학부 집행위원회의 역할과 주요 활동을 확인합니다.",
    descriptionEn: "Learn what SoC Student Council does for School of Computing students.",
    href: "/about#intro",
  ...
  },
  {
    ...
    descriptionKo: "전산학부 집행위원회 조직도를 확인합니다.",
    descriptionEn: "View the SoC Student Council organization chart.",
    href: "/about#people",
