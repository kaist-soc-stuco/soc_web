...
const isChatPage = (value: unknown): value is ChatPageResponse => exact(value, ['kind', 'externalUrl']) && value.kind === 'EXTERNAL_LINK_NOTICE' && string(value.externalUrl) || exact(value, ['kind']) && value.kind === 'INTERNAL_CHAT';
