...
export const PermissionFlags = {
  POST_CREATE: Permissions.POST_CREATE,
  POST_OFFICIAL: Permissions.POST_OFFICIAL,
  POST_ANNOUNCEMENT: Permissions.POST_ANNOUNCEMENT,
  VIEW_SECRET_POST: Permissions.VIEW_SECRET_POST,
  COMMENT_CREATE: Permissions.COMMENT_CREATE,
  MODERATE_POST_COMMENT: Permissions.MODERATE_POST_COMMENT,
  MANAGE_SUGGESTION_REPLY: Permissions.MANAGE_SUGGESTION_REPLY,
  MANAGE_BOARD_SETTINGS: Permissions.MANAGE_BOARD_SETTINGS,
  ...
  MANAGE_POLL: Permissions.MANAGE_POLL,
  VIEW_USERS: Permissions.VIEW_USERS,
  MANAGE_USERS: Permissions.MANAGE_USERS,
  VIEW_CONTACTS: Permissions.VIEW_CONTACTS,
